...
NEWSCHEMA('Order').make(function(schema) {
	...
	schema.define('phone', 'Phone', false);
	...
	schema.define('billingstreet', 'String(30)', false);
	schema.define('billingnumber', 'String(15)', false);
	schema.define('billingzip', 'Zip', false);
	schema.define('billingcity', 'String(30)', false);
	schema.define('billingcountry', 'String(30)', false);
