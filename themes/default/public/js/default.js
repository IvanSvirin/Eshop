...
$(document).ready(function () {
    ...
    $('.size-choice').click(function () {
        size = $('.size-choice option:selected').text();
    });
    var weave = '';
    $('.weave-choice').click(function () {
        weave = $('.weave-choice option:selected').text();
    });
    ...
    var buy = $('.detail-buy').on('click', function () {
        ...
        checkout.append(id, price, size, weave, 1);
...
COMPONENT('checkout', function () {
    ...
    self.append = function (id, price, size, weave, count) {
        var cart = CACHE('cart');
        var is = false;
        var counter = 0;
        ...
        !is && cart.push({id: id, price: price, size: size, weave: weave, count: count});
